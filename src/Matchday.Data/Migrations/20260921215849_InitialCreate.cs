        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ClockDisplay = table.Column<string>(type: "text", nullable: true),
                    HomeTeamId = table.Column<int>(type: "integer", nullable: false),
                    AwayTeamId = table.Column<int>(type: "integer", nullable: false),
                    HomeScore = table.Column<int>(type: "integer", nullable: true),
                    AwayScore = table.Column<int>(type: "integer", nullable: true),
                    Venue = table.Column<string>(type: "text", nullable: true),
                    HomeFormation = table.Column<string>(type: "text", nullable: true),
                    AwayFormation = table.Column<string>(type: "text", nullable: true),
                    DetailSyncedAt = table.Column<DateTimeOffset>(type: "timestamp with time zone", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ClockDisplay = table.Column<string>(type: "text", nullable: false),
                    TeamId = table.Column<int>(type: "integer", nullable: true),
                    PrimaryPlayerId = table.Column<int>(type: "integer", nullable: true),
                    SecondaryPlayerId = table.Column<int>(type: "integer", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Incidents_Players_PrimaryPlayerId",
                        column: x => x.PrimaryPlayerId,
                        principalTable: "Players",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Incidents_Players_SecondaryPlayerId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Incidents_MatchId_Sequence",
                table: "Incidents",
                columns: new[] { "MatchId", "Sequence" },
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_Incidents_PrimaryPlayerId",
                table: "Incidents",
                column: "PrimaryPlayerId");

            migrationBuilder.CreateIndex(
                name: "IX_Incidents_SecondaryPlayerId",
                table: "Incidents",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_LineupEntries_MatchId_PlayerId",
                table: "LineupEntries",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Matches_ProviderId",
                table: "Matches",
                column: "ProviderId",
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_Players_ProviderId",
                table: "Players",
                column: "ProviderId",
                unique: true);
